    ...
    <SharedLayout>
      <div className="h-5/6 p-10">
        <div className="p-2 mb-2">
          <span className=" text-4xl text-information">Courses</span>
        </div>
        <div className="flex space-x-8 overflow-x-auto px-4 pb-10 bg-white">
          {cards.map((card, index) => (
            <Card key={index} className="h-100 flex w-1/3 flex-shrink-0 justify-around px-10 py-14 bg-white text-black">
