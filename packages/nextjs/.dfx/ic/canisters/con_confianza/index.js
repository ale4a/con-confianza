...
import { idlFactory } from './con_confianza.did.js';
export { idlFactory } from './con_confianza.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CON_CONFIANZA;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./con_confianza.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the con_confianza canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./con_confianza.did.js")._SERVICE>}
 */
export const con_confianza = createActor(canisterId);
